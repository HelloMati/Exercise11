...
# created a new variable called parts using the split method on the beligum string - used colon as the deault seperator
parts = Belgium1.split(':')
# created a new variable coneverting parts 1 and 3 into integers and added them together
